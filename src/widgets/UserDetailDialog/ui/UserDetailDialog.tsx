...
import { useUserDetailQuery } from "../../../entities/user/queries/useUserQuery"
...
export const UserDetailDialog = ({ isOpen, onClose, userId }: UserDetailDialogProps) => {
  const { data: user } = useUserDetailQuery(userId ?? 0)
